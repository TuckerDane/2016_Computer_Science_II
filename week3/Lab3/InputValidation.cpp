...
***************************************************************************************************/
int integerValidation(int uinput)
{
...
int boundsValidation(int userInput, int min, int max)
{
	...
	userInput = integerValidation(userInput);				// validate that userInput is an integer
	...
	while (validated == false)								// while the userInput value is not validated
	{
		if (userInput < min)								// if the userInput is less than the minimum value allowed
		{
			...
			userInput = integerValidation(userInput);		// userInput is validated as an integer
		}
		if (userInput > max)
		{
